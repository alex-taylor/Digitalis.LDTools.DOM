...
namespace Digitalis.LDTools.DOM
{
    ...
    /// <summary>
    /// Implements <see cref="T:Digitalis.LDTools.DOM.API.ISave"/>. This class cannot be inherited.
    /// </summary>
    [Serializable]
    [Export(typeof(IMetaCommand))]
    [MetaCommandPattern(@"^0\s+SAVE\s*$")]
    [DefaultIcon(typeof(Resources), "SaveIcon")]
    [TypeName(typeof(Resources), "Save")]
    [ElementCategory(typeof(Resources), "ElementCategory_MetaCommand")]
    public sealed class LDSave : MetaCommand, ISave
    {
        ...
        protected override StringBuilder GenerateCode(StringBuilder sb, CodeStandards codeFormat, uint overrideColour, ref Matrix4d transform, WindingDirection winding)
        {
            if (CodeStandards.Full == codeFormat || CodeStandards.OfficialModelRepository == codeFormat)
                sb.AppendFormat("0 SAVE{0}", LineTerminator);
        ...
        /// <summary>
        /// Initializes an instance of the <see cref="LDSave"/> class with default values.
        /// </summary>
        public LDSave()
        {
        }
        ...
        /// <summary>
        /// Initializes an instance of the <see cref="LDSave"/> class with the specified values.
        /// </summary>
        /// <param name="code">The LDraw code representing this <i>SAVE</i> meta-command.</param>
        /// <exception cref="T:System.FormatException">The supplied string was not valid LDraw <i>SAVE</i> meta-command code.</exception>
        /// <example>
        /// <code>
        /// LDSave save = new LDSave("0 SAVE");
        /// </code>
        /// </example>
        public LDSave(string code)
        {
            string[] fields = code.Split(WhitespaceChars, StringSplitOptions.RemoveEmptyEntries);

            if (fields.Length < 2)
                throw new FormatException("LDraw SAVE code must have 2 fields");

            if ("0" != fields[0])
                throw new FormatException("LDraw SAVE code must start with '0'");
        ...
        /// <remarks>
        /// <para>
        /// <see cref="LDSave"/> elements do not have editable parameters, so do not provide an <see cref="T:Digitalis.LDTools.DOM.API.IElementEditor"/>.
        /// </para>
        /// </remarks>
        ...
        /// <inheritdoc />
        public override Image Icon { get { return Resources.SaveIcon; } }

        /// <inheritdoc />
        public override string TypeName { get { return Resources.Save; } }
        ...
        /// <remarks>
        /// <para>
        /// <see cref="T:Digitalis.LDTools.DOM.API.ISave"/> is not a state-element.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>
        /// <see cref="T:Digitalis.LDTools.DOM.API.ISave"/> is not a top-level element.
        /// </para>
        /// </remarks>
