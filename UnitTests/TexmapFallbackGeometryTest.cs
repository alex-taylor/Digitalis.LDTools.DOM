...
namespace UnitTests
{
    ...
    [TestClass]
    public sealed class TexmapFallbackGeometryTest : ITexmapGeometryTest
    {
        ...
        protected override ITexmapGeometry CreateTestTexmapGeometry()
        {
            ...
            return texmap.FallbackGeometry;
        }
        ...
        public override void DefinitionTest()
        {
            ...
            Assert.AreEqual(TexmapGeometryType.Fallback, geometry.GeometryType);
            Assert.IsFalse(geometry.IsImmutable);
            Assert.IsNotNull(geometry.Icon);
            Assert.AreEqual(Resources.Geometry_Fallback, geometry.TypeName);
