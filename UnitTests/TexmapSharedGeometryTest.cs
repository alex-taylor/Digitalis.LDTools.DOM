...
namespace UnitTests
{
    ...
    [TestClass]
    public sealed class TexmapSharedGeometryTest : ITexmapGeometryTest
    {
        ...
        public override void DefinitionTest()
        {
            ...
            Assert.AreEqual(TexmapGeometryType.Shared, geometry.GeometryType);
            Assert.IsFalse(geometry.IsImmutable);
            Assert.IsNotNull(geometry.Icon);
            Assert.AreEqual(Resources.Geometry_Shared, geometry.TypeName);
