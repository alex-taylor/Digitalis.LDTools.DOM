...
namespace Digitalis.LDTools.DOM.API
{
    ...
    /// <summary>
    /// Represents an LDraw line as defined in
    ///     <see href="http://www.ldraw.org/article/218.html#lt2">the LDraw.org File Format specification</see>.
    /// </summary>
    /// <remarks>
    ///
    /// <h3>Analytics</h3>
    /// <see cref="IGraphic.IsDuplicateOf">IsDuplicateOf()</see> will return <c>true</c> if <i>graphic</i> is an instance of
    /// <b>ILine</b> and has the same values for <see cref="IGraphic.ColourValue"/> and <see cref="IGraphic.Coordinates"/>. The
    /// ordering of the members of <see cref="IGraphic.Coordinates"/> is not important.
    ///
    /// <h3>Code-generation</h3>
    /// <see cref="IDOMObject.ToCode">ToCode()</see> will generate a single LDraw <i>line</i> statement whose values are
    /// determined by <see cref="IGraphic.ColourValue"/>, <see cref="Vertex1"/> and <see cref="Vertex2"/>. If
    /// <see cref="IPageElement.IsLocalLock"/> is <c>true</c> the statement will be prefixed with the
    ...
    /// <i>codeFormat</i> is <see cref="CodeStandards.PartsLibrary"/> then no code will be generated; otherwise the <i>line</i>
    /// statement will be prefixed with the <i>MLCAD HIDE</i> and <i>GHOST</i> meta-commands as required.
    /// <p/>
    ...
    ///
    /// <h3>Geometry</h3>
    /// The <see cref="IGeometric.Origin"/> of an <b>ILine</b> is <see cref="Vertex1"/>.
    /// <p/>
    /// <see cref="IGeometric.ReverseWinding">ReverseWinding()</see> swaps the values of <see cref="Vertex1"/> and
    /// <see cref="Vertex2"/>.
    ///
    /// <h3>Self-description</h3>
    /// <b>ILine</b> returns the following values:
    /// <p/>
    /// <list type="table">
    ///     <listheader><term>Property</term><description>Value</description></listheader>
    ///     <item><term><see cref="IDOMObject.ObjectType"/></term><description><see cref="DOMObjectType.Line"/></description></item>
    ...
    ///     <item><term><see cref="IGraphic.CoordinatesCount"/></term><description>2</description></item>
    ...
    ///
    /// </remarks>
    public interface ILine : IGraphic
    {
        #region Properties

        /// <summary>
        /// Gets or sets the first vertex of the <see cref="ILine"/>.
        /// </summary>
        /// <exception cref="System.ObjectDisposedException">The <see cref="ILine"/> is
        ///     <see cref="IDOMObject.IsDisposed">disposed</see>.</exception>
        /// <exception cref="ObjectFrozenException">The property is set and the <see cref="ILine"/> is
        ///     <see cref="IDOMObject.IsFrozen">frozen</see>.</exception>
        /// <exception cref="System.NotSupportedException">The property is set and the <see cref="ILine"/> is
        ///     <see cref="IDOMObject.IsImmutable">immutable</see>.</exception>
        /// <exception cref="ElementLockedException">The property is set and the <see cref="ILine"/> is
        ...
        /// <summary>
        /// Gets or sets the second vertex of the <see cref="LDLine"/>.
        /// </summary>
        /// <exception cref="System.ObjectDisposedException">The <see cref="ILine"/> is
        ///     <see cref="IDOMObject.IsDisposed">disposed</see>.</exception>
        /// <exception cref="ObjectFrozenException">The property is set and the <see cref="ILine"/> is
