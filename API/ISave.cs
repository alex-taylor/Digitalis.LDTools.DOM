...
{
    /// <summary>
    /// Represents an LDraw <i>SAVE</i> meta-command as defined in
    ///     <see href="http://www.ldraw.org/article/218/#save">the LDraw.org File Format specification</see>.
    /// </summary>
    /// <remarks>
    ///
    /// <h3>Code-generation</h3>
    /// If <i>codeFormat</i> is either <see cref="CodeStandards.Full"/> or <see cref="CodeStandards.OfficialModelRepository"/>,
    /// <see cref="IDOMObject.ToCode">ToCode()</see> will append the <i>SAVE</i> meta-command to <i>sb</i>.
    ///
    /// <h3>Self-description</h3>
    /// <b>ISave</b> returns the following values:
    /// <p/>
    /// <list type="table">
    ...
    ///
    /// </remarks>
    public interface ISave : IMetaCommand
    {
    }
}
