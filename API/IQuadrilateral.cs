...
namespace Digitalis.LDTools.DOM.API
{
    ...
    /// <summary>
    /// Represents an LDraw quadrilateral as defined in
    ///     <see href="http://www.ldraw.org/article/218.html#lt4">the LDraw.org File Format specification</see>.
    /// </summary>
    /// <remarks>
    ///
    /// <h3>Analytics</h3>
    /// <see cref="IGraphic.IsDuplicateOf">IsDuplicateOf()</see> will return <c>true</c> if <i>graphic</i> is an instance of
    /// <b>IQuadrilateral</b> and has the same values for <see cref="IGraphic.ColourValue"/> and <see cref="IGraphic.Coordinates"/>.
    /// The ordering of the members of <see cref="IGraphic.Coordinates"/> is not important.
    ///
    /// <h3>Code-generation</h3>
    /// <see cref="IDOMObject.ToCode">ToCode()</see> will generate a single LDraw <i>quadrilateral</i> statement whose values are
    /// determined by <see cref="IGraphic.ColourValue"/>, <see cref="Vertex1"/>, <see cref="Vertex2"/>, <see cref="Vertex3"/>
    /// and <see cref="Vertex4"/>. If <see cref="IPageElement.IsLocalLock"/> is <c>true</c> the statement will be prefixed with
    /// the <i>!DIGITALIS_LDTOOLS_DOM LOCKNEXT</i> meta-command.
    /// <p/>
    ...
    ///
    /// <h3>Geometry</h3>
    /// The <see cref="IGeometric.Origin"/> of an <b>IQuadrilateral</b> is <see cref="Vertex1"/>.
    /// <p/>
    /// <see cref="IGeometric.ReverseWinding">ReverseWinding()</see> swaps the values of <see cref="Vertex1"/> and
    /// <see cref="Vertex4"/> and the values of <see cref="Vertex2"/> and <see cref="Vertex3"/>.
    ///
    /// <h3>Self-description</h3>
    /// <b>IQuadrilateral</b> returns the following values:
    /// <p/>
    /// <list type="table">
    ///     <listheader><term>Property</term><description>Value</description></listheader>
    ///     <item><term><see cref="IDOMObject.ObjectType"/></term><description><see cref="DOMObjectType.Quadrilateral"/></description></item>
    ...
    ///
    /// </remarks>
    public interface IQuadrilateral : IGraphic
    {
        #region Analytics

        /// <summary>
        /// Gets a value indicating whether the <see cref="IQuadrilateral"/> is bow-tied.
        /// </summary>
        /// <exception cref="System.ObjectDisposedException">The <see cref="IQuadrilateral"/> is
        ...
        /// <summary>
        /// Repairs a bow-tied <see cref="IQuadrilateral"/>.
        /// </summary>
        /// <exception cref="System.ObjectDisposedException">The <see cref="IQuadrilateral"/> is
        ///     <see cref="IDOMObject.IsDisposed">disposed</see>.</exception>
        /// <exception cref="ObjectFrozenException">The property is set and the <see cref="IQuadrilateral"/> is
        ///     <see cref="IDOMObject.IsFrozen">frozen</see>.</exception>
        /// <exception cref="System.NotSupportedException">The property is set and the <see cref="IQuadrilateral"/> is
        ///     <see cref="IDOMObject.IsImmutable">immutable</see>.</exception>
        /// <exception cref="ElementLockedException">The property is set and the <see cref="IQuadrilateral"/> is
        ///     <see cref="IPageElement.IsLocked">locked</see>.</exception>
        /// <remarks>
        /// If the <see cref="IQuadrilateral"/> is not bow-tied, this method will have no effect.
        /// </remarks>
        void RepairBowtie();
        ...
        /// <summary>
        /// Gets or sets the first vertex of the <see cref="IQuadrilateral"/>.
        /// </summary>
        /// <exception cref="System.ObjectDisposedException">The <see cref="IQuadrilateral"/> is
        ///     <see cref="IDOMObject.IsDisposed">disposed</see>.</exception>
        /// <exception cref="ObjectFrozenException">The property is set and the <see cref="IQuadrilateral"/> is
        ...
        /// <summary>
        /// Gets or sets the second vertex of the <see cref="IQuadrilateral"/>.
        /// </summary>
        /// <exception cref="System.ObjectDisposedException">The <see cref="IQuadrilateral"/> is
        ///     <see cref="IDOMObject.IsDisposed">disposed</see>.</exception>
        /// <exception cref="ObjectFrozenException">The property is set and the <see cref="IQuadrilateral"/> is
        ...
        /// <summary>
        /// Gets or sets the third vertex of the <see cref="IQuadrilateral"/>.
        /// </summary>
        /// <exception cref="System.ObjectDisposedException">The <see cref="IQuadrilateral"/> is
        ///     <see cref="IDOMObject.IsDisposed">disposed</see>.</exception>
        /// <exception cref="ObjectFrozenException">The property is set and the <see cref="IQuadrilateral"/> is
        ...
        /// Raises the <see cref="IGraphic.CoordinatesChanged"/> event when its value changes.
        /// </remarks>
        Vector3d Vertex3 { get; set; }

        /// <summary>
        /// Gets or sets the fourth vertex of the <see cref="IQuadrilateral"/>.
        /// </summary>
        /// <exception cref="System.ObjectDisposedException">The <see cref="IQuadrilateral"/> is
        ///     <see cref="IDOMObject.IsDisposed">disposed</see>.</exception>
        /// <exception cref="ObjectFrozenException">The property is set and the <see cref="IQuadrilateral"/> is
        ...
        ///     <see cref="IPageElement.IsLocked">locked</see>.</exception>
        /// <remarks>
        /// This is equivalent to getting or setting the fourth member of <see cref="IGraphic.Coordinates"/>.
        /// <p/>
        /// Raises the <see cref="IGraphic.CoordinatesChanged"/> event when its value changes.
        /// </remarks>
        Vector3d Vertex4 { get; set; }

        /// <summary>
        /// Gets the surface-normal of the <see cref="IQuadrilateral"/>.
        /// </summary>
        /// <exception cref="System.ObjectDisposedException">The <see cref="IQuadrilateral"/> is
        ///     <see cref="IDOMObject.IsDisposed">disposed</see>.</exception>
        /// <remarks>
        /// <para>
        /// The returned value is normalised and extends outwards from the front surface of the <see cref="IQuadrilateral"/>,
        /// where 'front' assumes that the <see cref="IQuadrilateral"/>'s vertices are wound counter-clockwise.
        /// </para>
        /// </remarks>
        Vector3d Normal { get; }
